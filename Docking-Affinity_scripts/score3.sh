...
function compute_scores() {
    ...
    local dlscore=$HOME/contrib/dlscore/dlscore
    local score_dsx=~/work/lenjuanes/script/score_dsx.sh
    local score_xscore=~/work/lenjuanes/script/score_xscore.sh
